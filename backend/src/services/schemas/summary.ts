...
export const SermonSummarySchema = z.object({
  ...
  bibleVerses: z.array(z.string()).describe("Bible verses mentioned with context, empty array if none"),
  quotes: z.array(z.string()).describe("2-4 notable quotes from the speaker verbatim"),
...
export type SermonSummaryOutput = z.infer<typeof SermonSummarySchema>;
